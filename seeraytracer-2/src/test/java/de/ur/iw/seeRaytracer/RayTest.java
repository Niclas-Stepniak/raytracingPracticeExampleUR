...
class RayTest {
    ...
    void intersectWithCube() {
        ...
        Ray rayMiss = new Ray(new Vector3D(-0.5, 0.5, 0.5), new Vector3D(0, 1, 0));
        ...
        assertFalse(rayMiss.intersectWithCube(cube));
        assertTrue(rayX.intersectWithCube(cube));
        assertTrue(rayY.intersectWithCube(cube));
        assertTrue(rayZ.intersectWithCube(cube));
    }
}